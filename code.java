...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Belgachia Metro Station");
			g.addVertex("Central kolkata metro Metro Station");
			g.addVertex("Chandni Chowk Metro Station");
			g.addVertex("Dumdum Metro Station");
			g.addVertex("Esplanade Metro Station");
			g.addVertex("Girish Park Metro Station");
			g.addVertex("Gitanjali Metro Station");
			g.addVertex("Jatin Das Park Metro Station");
			g.addVertex("Kalighat Metro Station");
			g.addVertex("Kavi Nazrul Metro Station");
			g.addVertex("Kavi Subhash Metro Station");
			g.addVertex("Maidan Metro Station");
			g.addVertex("Mahatma Gandhi Road Metro Station");
			g.addVertex("Mahanayak Uttam Kumar Metro Station");
			g.addVertex("Netaji Metro Station");
			g.addVertex("Park Street Metro Station");
			g.addVertex("Rabindra Sarobar Metro Station");
			g.addVertex("Rabindra Sadan Metro Station");
			g.addVertex("Sovabazar Metro Station");
			g.addVertex("Shyambazar Metro Station");
			
			g.addEdge("Belgachia Metro Station", "Central kolkata metro Metro Station", 8);
			g.addEdge("Central kolkata metro Metro Station", "Chandni Chowk Metro Station", 10);
			g.addEdge("Chandni Chowk Metro Station", "Esplanade Metro Station", 8);
			g.addEdge("Chandni Chowk Metro Station", "Dumdum Metro Station", 6);
			g.addEdge("Dumdum Metro Station", "Girish Park Metro Station", 9);
			g.addEdge("Girish Park Metro Station", "Gitanjali Metro Station", 7);
			g.addEdge("Gitanjali Metro Station", "Jatin Das Park Metro Station", 6);
			g.addEdge("Kalighat Metro Station", "Kavi Nazrul Metro Station", 15);
			g.addEdge("Kavi Nazrul Metro Station", "Mahanayak Uttam Kumar Metro Station", 6);
			g.addEdge("Mahanayak Uttam Kumar Metro Station", "Dumdum Metro Station", 7);
			g.addEdge("Dumdum Metro Station", "Mahatma Gandhi Road Metro Station", 1);
			g.addEdge("Mahatma Gandhi Road Metro Station", "Maidan Metro Station", 2);
			g.addEdge("Maidan Metro Station", "Kavi Subhash Metro Station", 5);
			g.addEdge("Mahatma Gandhi Road Metro Station", "Netaji Metro Station", 2);
			g.addEdge("Netaji Metro Station", "Park Street Metro Station", 7);
			g.addEdge("Park Street Metro Station", "Rabindra Sarobar Metro Station", 8);
			g.addEdge("Girish Park Metro Station", "Rabindra Sadan Metro Station", 2);
			g.addEdge("Shyambazar Metro Station", "Rabindra Sadan Metro Station", 2);
			g.addEdge("Shyambazar Metro Station", "Sovabazar Metro Station", 3);
		}
